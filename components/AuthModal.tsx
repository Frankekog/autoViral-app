        ...
        <div className="p-8">
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">
              {view === 'login' ? 'Sign in to your AutoViral account' : 'Start generating viral videos today'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {view === 'signup' && (
              <div className="animate-fade-in-down">
                ...
                <input
                  ...
                  className="w-full rounded-lg bg-slate-950 border border-slate-700 p-3 text-white placeholder-slate-600 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="mt-6 w-full rounded-lg bg-brand-600 py-3 font-bold text-white transition-all hover:bg-brand-500 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center"
            >
              {isLoading ? (
          ...
          <button 
            type="button"
            onClick={() => { setIsLoading(true); setTimeout(() => { setIsLoading(false); onLogin(); }, 800); }}
